var SERVER 		= 	"192.168.1.100";				// Wowza szerver elérése
var STREAM_APP 	=	"katved";						// Wowza application név
var PHP_SERVER 	= 	"192.168.1.100";				// apache szerver elérhetősége
...
{
		console.log("No Wifi");
		document.getElementById("wifi2").innerHTML="Szerver : <span style='color:red;'>nem csatlakozik</span>";
...
function statusz_callback(resp)
{
    ...
    document.getElementById("wifi").innerHTML="Csatlakozva a szerverhez";
